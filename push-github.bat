...
echo ============================================
echo.
set /p GITHUB_TOKEN="GitHub token'ini yapistir ve Enter'a bas: "

git config user.email "gavalkadir2-tech@users.noreply.github.com"
git config user.name "gavalkadir2-tech"
